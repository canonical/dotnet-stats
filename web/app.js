...
(function () {
  ...
  function reportTable(parent, title, head, rowsHtml, note) {
    ...
    if (note) wrap.appendChild(el("p", "u-text--muted report-note", note));
  ...
  function renderReportToolbar(root, months, facts) {
    ...
    var archive = el("a", "p-button", "Report archive");
    archive.href = "reports.html";
    archive.title = "Every archived monthly report";
  ...
  function renderReportMethod(root, facts) {
    ...
    box.appendChild(ul);
    box.appendChild(el("p", "u-text--muted report-note",
